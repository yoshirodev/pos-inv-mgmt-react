...
export const assignPersonel        = (data) => API.patch("/services/assign-personel", data);

// ── Service Personnel ──────────────────────────────────────────
export const getPersonel    = ()     => API.get("/services/personel");
export const createPersonel = (data) => API.post("/services/personel", data);
export const deletePersonel = (id)   => API.delete(`/services/personel/${id}`);
