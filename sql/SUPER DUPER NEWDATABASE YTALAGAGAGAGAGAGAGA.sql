...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2026 at 03:31 PM
...
(15, '100 p Plastic Container', 'container', 150.00, 180, '20x30plasticforcontainers.png', 90, 'Storage Containers', 'Robton Industries', NULL, '2026-05-16 23:54:35', 30, 25, 10, 0, 'A simple plastic cover/bag used to protect or wrap containers for storage. Durable, lightweight, and used mainly for covering purposes.', NULL);
...
--
ALTER TABLE `components`
  MODIFY `component_id` int(255) NOT NULL AUTO_INCREMENT;
