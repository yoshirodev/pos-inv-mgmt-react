...
(1, '5 Gal. Slim Container', 'container', 450.00, 85, '5galslimcontainer.webp', 320, 'Water Storage', 'Pure Star', '2026-05-19 22:17:58', '2026-05-20 20:57:13', 28, 18, 45, 0, 'A slim 5-gallon plastic container used for storing water and household liquids. Durable, lightweight, and suitable for residential and commercial use.\n', 14),
...
(5, 'Pressure Gauge', 'equipment', 300.00, 55, 'pressuregauge.webp', 180, 'Water Pressure Equipment', 'Wika', '2026-05-19 22:17:58', '2026-05-20 20:57:36', 10, 5, 10, 0, 'A water pressure gauge used to monitor pressure levels in water systems and filtration equipment. Durable and accurate for residential and commercial applications.', 14),
...
(10, 'Heat Gun', 'tool', 900.00, 99, 'heatgun.jpeg', 650, 'Electrical Tools', 'Makita', '2026-05-19 22:17:58', '2026-05-20 20:57:13', 0, 8, 21, 0, 'A portable electric heat gun used for pipe fitting, plastic welding, paint removal, and heat shrinking applications. Designed for reliable heating performance and continuous use.\n', 14),
...
(15, '100 pcs Plastic Container', 'container', 150.00, 177, '20x30plasticforcontainers.png', 90, 'Storage Containers', 'Robton Industries', '2026-05-19 22:17:58', '2026-05-20 20:57:13', 30, 25, 10, 0, 'A simple plastic cover/bag used to protect or wrap containers for storage. Durable, lightweight, and used mainly for covering purposes.', 14);
...
--
ALTER TABLE `components`
  MODIFY `component_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
