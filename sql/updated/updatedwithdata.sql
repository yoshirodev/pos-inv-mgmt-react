...
(6, 1, 'Plastic Faucet / Spigot', 'Replacement faucet/spigot for 5-gallon slim container.', 90, 25, 45, 14),
(7, 1, 'Bottle Cap / Lid', 'Secure cap/lid for 5-gallon slim container.', 90, 10, 20, 14),
(8, 1, 'Rubber O-Ring', 'Rubber sealing O-ring for leak prevention.', 190, 5, 12, 14),
...
(14, 3, 'Elbow Connectors', 'Plastic elbow connectors for tubing.', 98, 12, 25, 14),
...
(1, '2026-05-18', 1, 11, 6450.00),
(4, '2026-05-19', 23, 56, 57745.00),
(28, '2026-04-20', 3, 6, 3200.00),
(29, '2026-04-21', 2, 4, 2100.00),
(30, '2026-04-22', 4, 8, 4500.00),
(31, '2026-04-23', 3, 5, 2800.00),
(32, '2026-04-24', 5, 10, 6200.00),
(33, '2026-04-25', 4, 7, 3900.00),
(34, '2026-04-26', 2, 3, 1500.00),
(35, '2026-04-27', 6, 12, 7800.00),
(36, '2026-04-28', 3, 6, 3100.00),
(37, '2026-04-29', 4, 9, 5000.00),
(38, '2026-04-30', 5, 11, 6900.00),
(39, '2026-05-01', 6, 13, 8200.00);
...
(1, '5 Gal. Slim Container', 'container', 450.00, 90, '5galslimcontainer.webp', 320, 'Water Storage', 'Pure Star', '2026-05-19 22:17:58', '2026-05-20 01:38:29', 28, 18, 45, 0, 'A slim 5-gallon plastic container used for storing water and household liquids. Durable, lightweight, and suitable for residential and commercial use.\n', 14),
...
(3, 'R.O Membranes', 'filter', 1200.00, 82, 'romembrane.jpg', 850, 'Water Filtration', 'Vontron', '2026-05-19 22:17:58', '2026-05-20 01:38:57', 101, 10, 10, 0, 'Reverse osmosis membranes designed for water purification systems. Efficient in removing impurities, bacteria, and dissolved solids for safe drinking water.\n', 14),
...
(10, 'TXN-0001', '2026-05-20 00:48:27', '5 Gal. Slim Container', 2, 450.00, 900.00, 'Cash', 1000.00, 100.00, 1, 11, NULL),
(11, 'TXN-0002', '2026-05-20 00:48:27', 'R.O Membranes', 1, 1200.00, 1200.00, 'GCash', 1200.00, 0.00, 3, 12, NULL),
(12, 'TXN-0003', '2026-05-20 00:48:27', 'Flow Meters', 3, 350.00, 1050.00, 'Cash', 1200.00, 150.00, 4, 14, NULL),
(13, 'TXN-0004', '2026-05-20 00:48:27', 'Filter Housing', 2, 650.00, 1300.00, 'Maya', 1300.00, 0.00, 6, 11, NULL),
(14, 'TXN-0005', '2026-05-20 00:48:27', 'Booster Pumps', 1, 3500.00, 3500.00, 'GCash', 4000.00, 500.00, 8, 12, NULL),
(15, 'TXN-0006', '2026-05-20 00:48:27', 'Sediment Filters', 4, 450.00, 1800.00, 'Cash', 2000.00, 200.00, 7, 14, NULL),
(16, 'TXN-0007', '2026-05-20 00:48:27', 'UV Lamps', 1, 1500.00, 1500.00, 'MariBank', 1500.00, 0.00, 12, 11, NULL),
(17, 'TXN-0008', '2026-05-20 00:48:27', 'Membrane Cleaning Service', 1, 1200.00, 1200.00, 'Cash', 1200.00, 0.00, NULL, 11, 1),
(18, 'TXN-0009', '2026-05-20 00:48:27', 'Repair and Upgrades Service', 1, 2500.00, 2500.00, 'GCash', 2500.00, 0.00, NULL, 12, 2),
(19, 'TXN-0010', '2026-05-20 00:48:27', 'Supply and Install Water Stations', 1, 5000.00, 5000.00, 'Cash', 5000.00, 0.00, NULL, 14, 3),
...
(1, 2026, 21, 24, 67, 64195.00),
(20, 2026, 16, 12, 25, 13500.00),
(21, 2026, 17, 15, 32, 18200.00),
(22, 2026, 18, 18, 40, 22500.00),
(23, 2026, 19, 14, 28, 16000.00);
...
--
ALTER TABLE `daily_sales`
  MODIFY `daily_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `monthly_sales`
  MODIFY `monthly_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `weekly_sales`
  MODIFY `weekly_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
